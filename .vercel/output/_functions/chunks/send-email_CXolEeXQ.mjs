...
//#region src/utils/emailTemplates.ts
...
function getNewDeviceLoginAlertTemplate(userName, deviceInfo, time) {
	return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
function getGroupInviteNotificationTemplate(userName, inviterName, groupName) {
	return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
function getAccountDeletionWarningTemplate(userName) {
	return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
function getOtpVerificationTemplate(code) {
	return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
function getGeneralNotificationEmailTemplate(title, message, actionUrl = "https://splits-bugs.vercel.app/dashboard") {
	return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
var POST = async ({ request }) => {
	try {
		...
		let html = "";
		if (templateId === "welcome") html = getWelcomeEmailTemplate(templateData.userName);
		else if (templateId === "new-device") html = getNewDeviceLoginAlertTemplate(templateData.userName, templateData.deviceInfo, templateData.time);
		else if (templateId === "group-invite") html = getGroupInviteNotificationTemplate(templateData.userName, templateData.inviterName, templateData.groupName);
		else if (templateId === "account-deletion") html = getAccountDeletionWarningTemplate(templateData.userName);
